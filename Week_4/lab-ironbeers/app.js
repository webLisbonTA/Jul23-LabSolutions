...
app.set('views', path.join(__dirname, 'starter-code/views'));

// ********* TO USE PARTIALS, WE HAVE TO REGISTER THEM: *********
hbs.registerPartials(path.join(__dirname, 'starter-code/views/partials'));

app.use(express.static(path.join(__dirname, 'starter-code/public')));
